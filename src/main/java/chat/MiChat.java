...
public class MiChat extends JFrame {
    ...
    public MiChat(final Juego game) {
        ...
        setBounds(PRINICIPAL_X, PRINICIPAL_Y, PRINICIPAL_WIDTH,
                PRINICIPAL_HEIGHT);
        setResizable(false);
        ...
        scrollPane.setBounds(SCROLL_PANE_X, SCROLL_PANE_Y, SCROLL_PANE_WIDTH,
                SCROLL_PANE_HEIGHT);
        ...
        texto.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                if (!texto.getText().equals("")) {
                    ...
                    game.getCliente().getPaqueteMensaje()
                            .setUserEmisor(game.getPersonaje().getNombre());
                    game.getCliente().getPaqueteMensaje()
                    ...
                    try {
                        game.getCliente().getSalida().writeObject(gson
                                .toJson(game.getCliente().getPaqueteMensaje()));
        ...
        enviar.setBounds(BOTON_ENVIAR_X, BOTON_ENVIAR_Y, BOTON_ENVIAR_WIDTH,
                BOTON_ENVIAR_HEIGHT);
