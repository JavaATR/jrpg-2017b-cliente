...
/**
 * Clase que administra el comando de chat. <br>
 */
public class Talk extends ComandosEscucha {
    /**
     * Ejecuta el chat entre clientes. <br>
     */
    @Override
    public final void ejecutar() {
        MiChat chat = null;
        String destino;
        juego.getCliente().setPaqueteMensaje((PaqueteMensaje) gson
                .fromJson(cadenaLeida, PaqueteMensaje.class));
