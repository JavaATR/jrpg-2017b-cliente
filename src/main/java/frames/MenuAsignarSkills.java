...
public class MenuAsignarSkills extends JFrame {
	...
	public MenuAsignarSkills(final Cliente cliente) {
		...
		contentPane.setBorder(new EmptyBorder(EMPTY_BORDER, EMPTY_BORDER, EMPTY_BORDER, EMPTY_BORDER));
		...
		labelFuerza.setBounds(LABEL_FUERZA[0], LABEL_FUERZA[1], LABEL_FUERZA[2], LABEL_FUERZA[HEIGHT_BOUND]);
		...
		labelDestreza.setBounds(LABEL_DESTREZA[0], LABEL_DESTREZA[1], LABEL_DESTREZA[2], LABEL_DESTREZA[HEIGHT_BOUND]);
		...
		labelInteligencia.setBounds(LABEL_INTELIGENCIA[0], LABEL_INTELIGENCIA[1], LABEL_INTELIGENCIA[2],
		...
		labelPuntos.setBounds(LABEL_PUNTOS[0], LABEL_PUNTOS[1], LABEL_PUNTOS[2], LABEL_PUNTOS[HEIGHT_BOUND]);
		...
		lblCantidadDePuntos.setBounds(LABEL_CANT_PUNTOS[0], LABEL_CANT_PUNTOS[1], LABEL_CANT_PUNTOS[2],
		...
		lblInteligencia.setBounds(LBL_INTELIGENCIA[0], LBL_INTELIGENCIA[1], LBL_INTELIGENCIA[2],
				LBL_INTELIGENCIA[HEIGHT_BOUND]);
		contentPane.add(lblInteligencia);

		JLabel lblDestreza = new JLabel("Destreza");
		lblDestreza.setForeground(Color.WHITE);
		lblDestreza.setHorizontalAlignment(SwingConstants.CENTER);
		lblDestreza.setBounds(LBL_DESTREZA[0], LBL_DESTREZA[1], LBL_DESTREZA[2], LBL_DESTREZA[HEIGHT_BOUND]);
		contentPane.add(lblDestreza);

		final JLabel lblFuerza = new JLabel("Fuerza");
		lblFuerza.setForeground(Color.WHITE);
		lblFuerza.setHorizontalAlignment(SwingConstants.CENTER);
		lblFuerza.setBounds(LBL_FUERZA[0], LBL_FUERZA[1], LBL_FUERZA[2], LBL_FUERZA[HEIGHT_BOUND]);
		...
		buttonConfirmar.setBounds(BTN_CONFIRMAR[0], BTN_CONFIRMAR[1], BTN_CONFIRMAR[2], BTN_CONFIRMAR[HEIGHT_BOUND]);
		...
		ImageIcon iconoReiniciar = new ImageIcon("recursos//botonReiniciar.png");
		...
		btnReasignarPuntos.setBounds(BTN_REASIGNAR_PUNTOS[0], BTN_REASIGNAR_PUNTOS[1], BTN_REASIGNAR_PUNTOS[2],
				BTN_REASIGNAR_PUNTOS[HEIGHT_BOUND]);
		contentPane.add(btnReasignarPuntos);
		buttonCancelar.setBounds(BTN_CANCELAR[0], BTN_CANCELAR[1], BTN_CANCELAR[2], BTN_CANCELAR[HEIGHT_BOUND]);
		...
		buttonRestarFuerza.setBounds(BTN_RESTAR_FUERZA[0], BTN_RESTAR_FUERZA[1], BTN_RESTAR_FUERZA[2],
				BTN_RESTAR_FUERZA[HEIGHT_BOUND]);
		...
		buttonRestarDestreza.setBounds(BTN_RESTAR_DESTREZA[0], BTN_RESTAR_DESTREZA[1], BTN_RESTAR_DESTREZA[2],
		...
		buttonRestarInteligencia.setBounds(BTN_RESTAR_INTELIGENCIA[0], BTN_RESTAR_INTELIGENCIA[1],
				BTN_RESTAR_INTELIGENCIA[2], BTN_RESTAR_INTELIGENCIA[HEIGHT_BOUND]);
		...
		buttonSumarFuerza.setBounds(BTN_SUMAR_FUERZA[0], BTN_SUMAR_FUERZA[1], BTN_SUMAR_FUERZA[2],
				BTN_SUMAR_FUERZA[HEIGHT_BOUND]);
		...
		buttonSumarDestreza.setBounds(BTN_SUMAR_DESTREZA[0], BTN_SUMAR_DESTREZA[1], BTN_SUMAR_DESTREZA[2],
		...
		buttonSumarInteligencia.setBounds(BTN_SUMAR_INTELIGENCIA[0], BTN_SUMAR_INTELIGENCIA[1],
				BTN_SUMAR_INTELIGENCIA[2], BTN_SUMAR_INTELIGENCIA[HEIGHT_BOUND]);
		contentPane.add(buttonSumarInteligencia);

		final JLabel imageLabel = new JLabel(new ImageIcon("recursos//background.jpg"));
		imageLabel.setBounds(IMAGE_LABEL[0], IMAGE_LABEL[1], IMAGE_LABEL[2], IMAGE_LABEL[HEIGHT_BOUND]);
