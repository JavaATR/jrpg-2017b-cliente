...
public class MenuInicioSesion extends JFrame {
	...
	public MenuInicioSesion(final Cliente cliente) {
		...
		lblNewLabel1.setBounds(PASSWORD_X, PASSWORD_Y, PASSWORD_WIDTH, PASSWORD_HEIGHT);
		...
		lblNewLabel.setBounds(USUARIO_X, USUARIO_Y, USUARIO_WIDTH, USUARIO_HEIGHT);
		...
		lblIngresar.setBounds(INGRESAR_X, INGRESAR_Y, INGRESAR_WIDTH, INGRESAR_HEIGHT);
		...
		userField.setBounds(USUARIO_TXT_X, USUARIO_TXT_Y, USUARIO_TXT_WIDTH, USUARIO_TXT_HEIGHT);
		...
		passwordField.setBounds(PASSWORD_TXT_X, PASSWORD_TXT_Y, PASSWORD_TXT_WIDTH, PASSWORD_TXT_HEIGHT);
		layeredPane.add(passwordField, new Integer(1));
		passwordField.setFont(new Font("Tahoma", Font.PLAIN, PASSWORD_TXT_FONT));
		JButton btnConectar = new JButton("");
		btnConectar.setBounds(BOTON_CONECTAR_X, BOTON_CONECTAR_Y, BOTON_CONECTAR_WIDTH, BOTON_CONECTAR_HEIGHT);
