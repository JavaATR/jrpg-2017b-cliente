...
public class MenuJugar extends JFrame {
	...
	public MenuJugar(final Cliente cliente) {
		...
		lblIniciarSesion.setBounds(SESION_X, SESION_Y, SESION_WIDTH, SESION_HEIGHT);
		...
		btnRegistrar.setBounds(BOTON_REGISTRARSE_X, BOTON_REGISTRARSE_Y, BOTON_REGISTRARSE_WIDTH,
		...
		btnIniciarSesion.setBounds(BOTON_SESION_X, BOTON_SESION_Y, BOTON_SESION_WIDTH, BOTON_SESION_HEIGHT);
