...
public class MenuMapas extends JFrame {
    ...
    public MenuMapas(final Cliente cliente) {
        ...
        lblAubenor.setBounds(AUBENOR_X, AUBENOR_Y, AUBENOR_WIDTH,
                AUBENOR_HEIGHT);
        ...
        btnAubenor.setBounds(BOTON_AUBENOR_X, BOTON_AUBENOR_Y,
                BOTON_AUBENOR_WIDTH, BOTON_AUBENOR_HEIGHT);
        ...
        btnEodrim.setBounds(BOTON_EODRIM_X, BOTON_EODRIM_Y, BOTON_EODRIM_WIDTH,
                BOTON_EODRIM_HEIGHT);
        ...
        btnAris.setBounds(BOTON_ARIS_X, BOTON_ARIS_Y, BOTON_ARIS_WIDTH,
                BOTON_ARIS_HEIGHT);
