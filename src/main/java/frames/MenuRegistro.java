...
public class MenuRegistro extends JFrame {
	...
	public MenuRegistro(final Cliente cliente) {
		...
		lblUsuario.setBounds(USUARIO_X, USUARIO_Y, USUARIO_WIDTH, USUARIO_HEIGHT);
		layeredPane.add(lblUsuario, new Integer(1));
		lblUsuario.setForeground(Color.WHITE);
		lblUsuario.setFont(new Font("Tahoma", Font.PLAIN, USUARIO_FONT));
		JLabel lblPassword = new JLabel("Password");
		lblPassword.setBounds(PASSWORD_X, PASSWORD_Y, PASSWORD_WIDTH, PASSWORD_HEIGHT);
		layeredPane.add(lblPassword, new Integer(1));
		lblPassword.setForeground(Color.WHITE);
		lblPassword.setFont(new Font("Tahoma", Font.PLAIN, PASSWORD_FONT));
		JLabel lblRegistrarse = new JLabel("Registrarse");
		lblRegistrarse.setBounds(REGISTRARSE_X, REGISTRARSE_Y, REGISTRARSE_WIDTH, REGISTRARSE_HEIGHT);
		layeredPane.add(lblRegistrarse, new Integer(2));
		lblRegistrarse.setForeground(Color.WHITE);
		lblRegistrarse.setFont(new Font("Tahoma", Font.PLAIN, REGISTRARSE_FONT));
		JButton btnRegistrarse = new JButton("");
		btnRegistrarse.setBounds(BOTON_REGISTRARSE_X, BOTON_REGISTRARSE_Y, BOTON_REGISTRARSE_WIDTH,
				BOTON_REGISTRARSE_HEIGHT);
		...
		pwPassword.setBounds(TXT_PASSWORD_X, TXT_PASSWORD_Y, TXT_PASSWORD_WIDTH, TXT_PASSWORD_HEIGHT);
		...
		txtUsuario.setBounds(TXT_USUARIO_X, TXT_USUARIO_Y, TXT_USUARIO_WIDTH, TXT_USUARIO_HEIGHT);
		layeredPane.add(txtUsuario, new Integer(1));
		txtUsuario.setColumns(TXT_USUARIO_COLUMNAS);
		JLabel labelBackground = new JLabel("");
		labelBackground.setBounds(BACKGROUND_X, BACKGROUND_Y, BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
