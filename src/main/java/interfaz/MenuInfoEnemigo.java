...
public class MenuInfoEnemigo {
	...
	public void graficar(Graphics g, int tipoMenu){
		...
		// dibujo el personaje
		g.drawImage(Recursos.elBryan.get(6)[0], x + menu.getWidth() / 2  - anchoPersonaje / 2, y + 70, 128, 128, null);

		// muestro el nombre
		g.setColor(Color.WHITE);
		g.setFont(new Font("Book Antiqua", 1, 20));
		Pantalla.centerString(g, new Rectangle(x, y + 15, menu.getWidth(), 0), "El Bryan");
...
//
	public void graficarMenuInformacion(Graphics g){
		...
		g.setColor(Color.BLACK);
		Pantalla.centerString(g, new Rectangle(x, y + 200, menu.getWidth(), 0), "El Bryan");
