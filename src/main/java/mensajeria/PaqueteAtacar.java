...
public class PaqueteAtacar extends Paquete implements Serializable, Cloneable {
	 ...
	 */
	public PaqueteAtacar(int idNumber, int idNumberEnemigo, int newSalud,
			int newEnergia, int newSaludEnemigo, int newEnergiaEnemigo,
			int newDefensa, int nuevaDefensaEnemigo, double probEvitarDano,
	 ...
	 */
	public void setIdEnemigo(int idNumberEnemigo) {
		this.idEnemigo = idNumberEnemigo;
	}
	 ...
	 */
	public void setNuevaSaludPersonaje(int newSaludPersonaje) {
	 ...
	 */
	public void setNuevaEnergiaPersonaje(int newEnergiaPersonaje) {
	 ...
	 */
	public void setNuevaSaludEnemigo(int newSaludEnemigo) {
		this.nuevaSaludEnemigo = newSaludEnemigo;
	}
	 ...
	 */
	public void setNuevaEnergiaEnemigo(int newEnergiaEnemigo) {
		this.nuevaEnergiaEnemigo = newEnergiaEnemigo;
	}
