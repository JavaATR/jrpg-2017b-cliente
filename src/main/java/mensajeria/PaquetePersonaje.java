...
public class PaquetePersonaje extends Paquete
	 ...
	 */
	public void setExperiencia(int experience) {
	 ...
	 */
	public final void anadirItem(int idItem, String nombre, int wearLocation,
			int bonusSalud, int bonusEnergia, int bonusAtaque, int bonusDefensa,
			int bonusMagia, String foto, String fotoEquipado) {
		try {
	 ...
	 */
	public final void sacarBonus(int bonusSalud, int bonusEnergia,
			int bonusAtaque, int bonusDefensa, int bonusMagia) {
	 ...
	 */
	public void actualizarTrueque(ArrayList<Item> itemsList) {
